...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data\_info }\OtherTok{\textless{}{-}}\NormalTok{ InterXshift}\SpecialCharTok{::}\FunctionTok{simulate\_data}\NormalTok{()}
...
Run the \texttt{InterXshift} main function passing in the data, number of
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim\_results }\OtherTok{\textless{}{-}}\NormalTok{ InterXshift}\SpecialCharTok{::}\FunctionTok{InterXshift}\NormalTok{(}\AttributeTok{W =}\NormalTok{ W,}
